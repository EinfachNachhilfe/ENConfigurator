...
document.addEventListener("DOMContentLoaded", function() {
  var teachingLocationRadios = document.querySelectorAll('input[name="teachingLocation"]');
  var teachingLocationRadios1 = document.querySelectorAll('input[name="unit45"]');
  var mycustomcheckbox1 = document.querySelectorAll('input[name="subjectMathe"]');
  var mycustomcheckbox2 = document.querySelectorAll('input[name="subjectDeutsch"]');
  var mycustomcheckbox3 = document.querySelectorAll('input[name="subjectEnglisch"]');
  var mycustomcheckbox4 = document.querySelectorAll('input[name="subjectFranzoesisch"]');
