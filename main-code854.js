...
const couponCodes = {
   ...
   "schulstart4z": { regex: /^schulstart4z$/i, message: 'Sie erhalten 2 x 90 Minuten kostenlose Nachhilfe!' },
...
if (configuratorForm) {
   ...
   var lessonValueFrench = 1.2;
   var lessonValueLatin = 1.4;
   var lessonValueSpanish = 0.8;
   var lessonValueItalian = 1.2;
   var lessonValuePhysics = 1.2;
   var lessonValueChemistry = 1.4;
   var lessonValueBiology = 0.8;
   var lessonValueGeography = 0.2;
   var lessonValueHistory = 0.2;
   var lessonValueSocialStudies = 0.2;
   var lessonValueComputerScience = 1.6;
   var lessonValuePhysicalEducation = 0.8;
   ...
   var tutorSalaryValueTandemLesson = 1.5; 
